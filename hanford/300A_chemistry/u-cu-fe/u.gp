...
GNUTERM = "aqua"
set y2tics nomirror font "Helvetica, 18"
set key bottom right Left
plot \
'pflotran001.tec' u 1:14 t 'UO_2^{2+}:  1 y' w l lw 2,\
'pflotran002.tec' u 1:14 t 'UO_2^{2+}:  2 y' w l lw 2,\
'pflotran003.tec' u 1:14 t 'UO_2^{2+}:  3 y' w l lw 2,\
'pflotran004.tec' u 1:14 t 'UO_2^{2+}:  4 y' w l lw 2,\
'pflotran005.tec' u 1:14 t 'UO_2^{2+}:  5 y' w l lw 2,\
'pflotran006.tec' u 1:14 t 'UO_2^{2+}: 10 y' w l lw 2,\
'pflotran001.tec' u 1:18 axes x1y2 t 'Cl^{/Symbol -}:  1 y' w l lw 2,\
'pflotran002.tec' u 1:18 axes x1y2 t 'Cl^{/Symbol -}:  2 y' w l lw 2,\
'pflotran003.tec' u 1:18 axes x1y2 t 'Cl^{/Symbol -}:  3 y' w l lw 2,\
'pflotran004.tec' u 1:18 axes x1y2 t 'Cl^{/Symbol -}:  4 y' w l lw 2,\
'pflotran005.tec' u 1:18 axes x1y2 t 'Cl^{/Symbol -}:  5 y' w l lw 2,\
'pflotran006.tec' u 1:18 axes x1y2 t 'Cl^{/Symbol -}: 10 y' w l lw 2
#    EOF
