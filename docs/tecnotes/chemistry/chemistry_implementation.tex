...
\EN
For simplicity, in what follows it is assumed that $\nu_\a\!=\!1$. In the multirate model the rates of sorption reactions are described through a kinetic relation given by
\EQ\label{sorbed}
...
\EA
for empty sites, where $S_\a^{\rm eq}$ denotes the equilibrium sorbed concentration.
