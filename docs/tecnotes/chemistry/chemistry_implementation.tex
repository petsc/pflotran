...
\noindent\underline{\bf Residual Function:} 

\noindent Unknown Variables: $\{C_j, \, C_c^l, \, S_{ic}^l\}$

\noindent Auxiliary Variables: $\{C_i^{}, \, C_c^s, \, S_c^s, \, S_c^l, \, S_{ic}^s, \, S_m^{},\,S_{im}^{}\}$
...
\noindent Colloid/Mineral Kinetic Sorption Reactions:
...
+ \sum_{ic} \nu_{ji}^{c} \frac{\p S_{ic}^{s,k+1}}{\p S_{i'c'n}^l}\right] \frac{V_n}{\Delta t} \nonumber\\
&\qquad \qquad
+\sum_{n''}q_{cnn''}\sum_{ic}\nu_{ji}^{c} \frac{\p S_{ic,nn''}^{l,k+1}}{\p S_{i'c'n'}^l} A_{nn''}^{},
\EA
\end{subequations}
\begin{subequations}
\BA
...
\noindent Auxiliary Derivatives (Kinetic):
\EQ
...
\noindent Auxiliary Derivatives (Local Equilibrium):
\EQ
\frac{\p C_{c}^s}{\p C_{c}^l} \eq \frac{k_c^f \Delta t}{1+k_c^f\Delta t},
\EN
\EQ
