...
\noindent Sorption site concentration is related to mobile and immobile colloid concentration and mineral volume fraction according to the expressions:
\BA
...
\EN
\noindent Site Conservation Equation:
\EQ
...
\noindent Primary Species Concentrations:
%\EQ
...
\noindent \underline{Relation Between Mobile-Immobile Collloid Exchange Rates $\widetilde I_c$ and $I_c$:}
\BA
