...
\begin{subequations}
\EQ\label{acont}
\frac{\p}{\p t} \varphi_\a\Psi_j^\a + \bnabla\cdot\bOmega_j^\a \eq -\sum_{il}\nu_{ji} \frac{\p S_{il}^\a}{\p t} - \Gamma_{\a\b} \big(\Psi_j^\a - \Psi_j^\b\big) -\sum_m\nu_{jm}I_m^\a,
\EN
for the primary continuum, and
\EQ
\frac{\p}{\p t} \varphi_\b\Psi_j^\b \eq -\sum_{il}\nu_{ji} \frac{\p S_{il}^\b}{\p t} + \Gamma_{\a\b} \big(\Psi_j^\a - \Psi_j^\b\big) -\sum_m\nu_{jm}I_m^\b,
\EN
\end{subequations}
