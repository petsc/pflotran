...
\EQ
R_{jn} \eq \varphi \frac{\Psi_{jn}^{t+\Delta t}-\Psi_{jn}^t}{\Delta t} + \sum_\a \frac{q_{j\a n}^{t+\Delta t}-q_{j\a n}^t}{\Delta t} + \sum_{n'} \Omega_{jnn'} A_{nn'} + \sum_m\nu_{jm}I_{mn},
\EN
becomes
\EQ
R_{jn} \eq \varphi \frac{\Psi_{jn}^{t+\Delta t}-\Psi_{jn}^t}{\Delta t} + \sum_\a \frac{k_\a}{1+k_\a\Delta t}\big(q_{j\a n}^{{\rm eq},\,t+\Delta t}-q_{j\a n}^{t}\big) + \sum_{n'} \Omega_{jnn'} A_{nn'} + \sum_m\nu_{jm}I_{mn},
\EN
