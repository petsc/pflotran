...
%R_ic:C_c'
\dfrac{\p R_{icn}}{\p C_{c'}^l}&\eq  \varphi_n^{} s_{ln}^{}\delta_{nn'}\delta_{cc'} \frac{\p S_{icn}^l}{\p C_{cn}}\frac{V_n}{\Delta t} + \delta_{cc'}\sum_{n''} q_{cnn''} \frac{\p S_{ic,nn''}^l}{\p C_{cn'}^l} A_{nn''}-\delta_{nn'}\delta_{cc'} V_n\frac{\p I_{icn}^l}{\p C_{cn}},\\
%R_ic:S_i'c'
\dfrac{\p R_{icn}}{\p S_{i'c'}^l}&\eq  \varphi_n^{} s_{ln}^{}\delta_{nn'}\delta_{ii'}\delta_{cc'} \frac{V_n}{\Delta t} + \delta_{cc'}\sum_{n''} q_{cnn''} \frac{\p S_{ic,nn''}^l}{\p S_{icn'}^l} A_{nn''}-\delta_{nn'}\delta_{cc'} V_n\frac{\p I_{icn}^l}{\p S_{i'cn}}.
\EA
\end{subequations}
