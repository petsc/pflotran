...
\noindent Colloids:
\EQ
\frac{\p}{\p t} \varphi C_c^f + \bnabla\cdot\bq C_c^f \eq -\frac{\p C_c^s}{\p t},
\EN
\EQ
\frac{\p C_c^s}{\p t} \eq k_c^f C_c^f - k_c^b C_c^s,
\EN

Sorbed Concentrations:
\EQ
\frac{\p}{\p t} \varphi\Psi_j +\bnabla\cdot\bOmega_j \eq -\sum_{ic} \nu_{ji} \frac{\p S_{ic}}{\p t},
\EN
...
\item[COLLOIDS] ~
\begin{deflist}{spa}
\item[MOBILE\_COLL] coll\_name \ conc [mol/m$^3$]
\item[IMMOBILE\_COLL] coll\_name \ conc [mol/m$^3$]
\end{deflist}
\item[END] ~
\end{deflist}
