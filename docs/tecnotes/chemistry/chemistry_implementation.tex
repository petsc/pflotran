...
\EQ\label{massactco2}
K_\c \eq \frac{f_\c}{a_\c} \eq \frac{\phi_\c P_\c}{a_\c} \eq \frac{\phi_\c y_\c P_g}{a_\c},
\EN
where the mole fraction of $\c$ in the gas phase, $y_\c$, is assumed to be given by
\EQ
y_\c \eq \frac{P_\c^g}{P_g} \eq \frac{P_g-P_\w^{\rm sat}(T)}{P_g},
\EN
...
\begin{subequations}
\EQ
x_\c \eq\frac{m_\c W_\w}{1+m_\c W_\w},
\EN
...
\EN
\end{subequations}
where $W_\w$ denotes the formula weight of water. Weight $w_i$ and mole $x_i$ fractions are related by the expression
\begin{subequations}
\EQ
