...
For a dual continuum model with primary continuum $\a$ and secondary continua denoted by $\b$, and with multirate sorption and mineral precipitation and dissolution the transport equations read
\begin{subequations}
\EQ\label{acont}
