...
In this expression
\EQ
N \eq\omega_\a^k - \displaystyle\sum_l \dfrac{S_{l\a}^{k}}{1+k_{l\a}^b\Delta t},
\EN
and
\EQ
...
\BA
\frac{\p R_{jn}}{\p \ln C_l^{k+1}} &\eq \sum_{i\a}
\frac{\nu_{ji} k_{i\a}^f}{1+k_{i\a}^b \Delta t}\frac{N}{D} \left\{
