...
\EQ
~_{\bu}\bJ_k^\a \eq -\rho_\a D_\a \bnabla\chi_k^\a,
\EN
and
\EQ
~_{\bv}\bJ_k^\a \eq -\eta_\a D_\a \bnabla x_k^\a,
\EN
corresponding to their Equations 12.158 and 12.160, p. 525--526. However, these relations are not compatible with Eqn.\eqref{transformation}. Indeed it follows that
\BA
W_k ~_{\bu}\bJ_k^\a &\eq -W_k\eta_\a D_\a \bnabla \left(\frac{W_k^{-1} \chi_k^\a}{\sum_i W_i^{-1}\chi_i^\a}\right),\\
&\eq -\rho_\a D_\a \bnabla \chi_k^\a - \rho_\a D_\a W_\a x_k^\a \sum_i W_i^{-1} \bnabla \chi_i^k,
\EA
using the relations
\EQ
\sum_k W_k^{-1} \chi_k^\a \eq W_\a^{-1} (\chi^\a),
\EN
and
\EQ
