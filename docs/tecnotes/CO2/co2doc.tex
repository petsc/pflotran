...
\EN
and the mole fraction of each phase present in the system $\zeta_\a$ defined by
\EQ
...
\BA
\zeta_\a &\eq \frac{n_\a}{n} \eq \frac{(n_\a/V_\a) (V_\a/V_p)}{\sum_\b (n_\b/ V_\b) (V_\b/V_p)},\nonumber\\
