...
K_{ij}^\a \eq \left(\frac{X_i^\a}{a_i}\right)^{z_j}
\left(\frac{a_j}{X_j^\a}\right)^{z_i},
\EN
...
\EQ\label{rxn2}
\frac{1}{z_j} \,\A_j + \frac{1}{z_i}\, (\chi_\a)_{z_i} \A_i \arrows \frac{1}{z_i} \,\A_i + \frac{1}{z_j}\, (\chi_\a)_{z_j} \A_j,
\EN
