...
Also, in the geomechanics grids are read as unstructured grids. Even if one needs to work with a structured grid, they have to set it up in the unstructured grid format.
