...
Primary variables for pure liquid, pure gas and two-phases systems are listed in Table~\ref{tvar}.
...
The conditions for phases to occur are considered in detail below.
