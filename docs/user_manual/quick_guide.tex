...
\begin{deflist}{000}
\item[FORWARD\_RATE\_CONSTANT] {\tt Value} [mol/cm$^2$/s]
\item[BACKWARD\_RATE\_CONSTANT] {\tt Value} [mol/cm$^2$/s]
\end{deflist}

\item [SITE\_FRACTION] {\tt Value}[---] \ \ \ \ \ (Continuation line `$\backslash$')
\item [RATE, RATES] {\tt Value} [mol/cm$^2$/s] (Continuation line `$\backslash$')
