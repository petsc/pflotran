...
CHEMISTRY keyword provides input for primary species, secondary species, minerals, gases, and sorption including ion exchange and surface complexation and a multirate formulation of surface complexation.
...
\begin{deflist}{00000}
\item Mineral Name \ \ \ Rate [mol/cm$^2$/s]
\end{deflist}
\item [(.,\,/,\,END)]
\item[SORPTION] ~
\begin{deflist}{000000000000000}
\item [SURFACE\_COMPLEXATION\_RXN]
\item [SITE\_FRACTION] Site Fractions
\item [RATES] Rates
\item [MINERAL] Mineral Name
\item[SITE] Site Name \ \ \ Site Density [mol/m$^3$]
\item[COMPLEX] ~
\begin{deflist}{0}
\item [Complex Name]
\item [(.,\,/,\,END)]
...
\subsection{Keyword: CONDITION (FLOW\_/TRANSPORT\_CONDITION)}
