...
\EQ
\bD_\a \eq \varphi s \Big(\tau D_0 + a_T \bI + \big(a_L-a_T\big)\frac{\bv\bv}{v}\Big),
\EN
with longitudinal and transverse dispersivity coefficients $a_L$, $a_T$, respectively, $\tau$ refers to tortuosity, and $D_0$ to the molecular diffusion coefficient.
