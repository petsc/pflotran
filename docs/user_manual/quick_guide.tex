...
\EQ
\bq_\a \eq -\frac{k}{\mu_\a} \big(\bnabla p-\rho_\a g \hat\bz\big), 
\EN
with permeability $k$ and fluid viscosity $\mu_\a$, and $Q_\a$ is the source/sink term.  
...
\item[SATURATION] {\tt [dirichlet, hydrostatic, zero\_gradient]}
...
\bf PRESSURE & Specifies the type of pressure condition.\\
 \bf TEMPERATURE & Specifies the type of temperature condition.\\
    ...
    \bf SATURATION & Specifies the type of concentration condition.\\
...
\bf SATURATION & Solute concentration at the datum.\\
