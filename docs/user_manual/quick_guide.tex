...
\begin{subequations}
\EQ
\frac{\p}{\p t} \epsilon\rho_r C_r T_f + \bnabla\cdot \big(-\epsilon\kappa_f\bnabla T_f\big) \eq -A_{fm} \kappa_{fm}\frac{\p T_m}{\p n},
\EN
and
\EQ
\frac{\p}{\p t} \rho_r C_r T_m + \frac{\p}{\p\xi}\cdot \big(-\kappa_m\frac{\p T_m}{\p\xi}\big) \eq 0,
\EN
for fracture and matrix temperatures $T_f$ and $T_m$, respectively. The boundary condition 
\EQ
