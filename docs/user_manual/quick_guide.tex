...
\noindent{\bf Description:} this keyword defines a spatial grid and specifies the geometric options employed in the simulation.
...
\noindent{\bf Description:} determines the flow mode: Richards (variably saturated porous media), MPH, MPHASE, FLASH2 (CO$_2$ + H$_2$O), THC (Thermal-Hydrologic-Chemical, in pro\-gress), IMMIS (Immisible).
