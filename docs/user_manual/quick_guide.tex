...
\EA
\end{subequations}
for the $m$th matrix node. The matrix node designated by $M$ refers to the outer most node in contact with the fracture. 
...
\parbox{4in}{\caption{Control volumes in DCDM multiple continuum model with fracture aperture $2\delta$ and matrix block size $d$.}}
\label{fminc}
\end{figure}
