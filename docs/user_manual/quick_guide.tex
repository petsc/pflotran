...
\hyperlink{target_stat}{\bf COMPUTE\_STATISTICS (STATISTICS)} & \\
\hyperlink{target_cond}{\bf CONDITION} & \\
\hyperlink{target_datset}{\bf DATASET} & \\
\hyperlink{target_dbg}{\bf DEBUG} & \\
\hyperlink{target_dif}{\bf DIFF} & \\
\hyperlink{target_fluid_properties}{\bf FLUID\_PROPERTIES} & \\
\hyperlink{target_gravity}{\bf GRAVITY} & \\
\hyperlink{target_grid}{\bf GRID} & \\
\hyperlink{target_invert}{\bf INVERT\_Z (INVERTZ)} & \\
\hyperlink{target_init}{\bf INITIAL\_CONDITION} & \\
\hyperlink{target_linsolv}{\bf LINEAR\_SOLVER} & \\
\hyperlink{target_mat}{\bf MATERIAL (MATERIALS, PHIK)} & \\
...
\hyperlink{target_sat}{\bf SATURATION\_FUNCTION (SATURATION\_FUNCTION, PCKR)} & \\
\hyperlink{target_src}{\bf SOURCE\_SINK} & \\
\hyperlink{target_strata}{\bf STRATIGRAPHY (STRATA)} & \\
\hyperlink{target_thrm}{\bf THERMAL\_PROPERTY (THERMAL\_PROPERTIES)} & \\
...
Primary\_Species & List of primary species that fully describe the chemical composition of the fluid. The set of primary species must form an independent set of species in terms of which all homogeneous aqueous equilibrium reactions can be expressed.\\
Secondary\_Species & List of aqueous species in equilibrium with primary species.\\
Gas\_Species & List of gas species.\\
\ldots &
\end{tabularx}
...
\subsection{Keyword: CONDITION (FLOW/TRANSPORT\_CONDITION)}
...
%\begin{minipage}{6.5in}
\begin{deflist}{0000000000}
\item [FLOW/TRANSPORT\_CONDITION] condition\_name
...
\begin{deflist}{00000000000000000}
    \item[PRESSURE]
      [dirichlet,
      hydrostatic,,
      zero\_gradient,
...
{\noindent\bf Explanation:}
\begin{description}
\item[FLOW/TRANSPORT\_CONDITION] initiates a condition entry and defines its name.
...
\noindent{\bf Input:}
\begin{deflist}{0000000000}
\item[MODE] \bf [IMMIS, MPH, RICHARDS, RICHARDS\_LITE, THC (\rm not implemented)]
\end{deflist}
...
\begin{comment}
\begin{description}
\item OUTPUT:  keyword to control output.\\
\item SCREEN PERIODIC: controls screen output frequency.\\
\item PERIODIC TIME: controls frequency of output times.\\
\item PERIODIC\_OBSERVATION TIMESTEP: frequency of output time step.\\
\item TIMES: list of output times.\\
\item PERIODIC\_OBSERVATION TIME: frequency of output time.\\
\item FORMAT TECPLOT POINT: Tecplot POINT output, valid for 1D and 2D problems.\\
\item FORMAT TECPLOT BLOCK: Tecplot BLOCK output.\\
\item FORMAT HDF5: HDF5 output format written to a .h5 file which can be read by Visit.\\
\item UNIT: time units of seconds (s), days (d), and years (y).\\
\item VELOCITIES: keyword to output velocities.\\
\item MASS\_BALANCE: keyword to output global mass balances and boundary fluxes.
\end{description}
\end{comment}
