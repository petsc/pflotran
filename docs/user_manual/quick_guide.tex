...
\hyperlink{target_fluid_properties}{FLUID_PROPERTIES} & \\
...
\subsection{Keyword: FLUID_PROPERTIES (FLUID_PROPERTY, FLUID_PROPERTIES)}
\shadowbox{
\begin{minipage}{6.5in}
\begin{deflist}{0000000000} 
\item[FLUID_PROPERTIES (FLUID_PROPERTY, FLUID_PROPERTIES)] 
\item diffusion base, diffusion_exponent
\item[(., /, END)
\end{deflist}
\end{minipage}
}
