...
\begin{subequations}
\BA
Q_i &\eq \sum_\a q_\a^V \eta_\a X_i^\a \delta(\br-\br_{ss}),\\
&\eq \sum_\a \frac{\eta_\a}{\rho_\a} q_\a^M X_i^\a \delta(\br-\br_{ss}),\\
&\eq \sum_\a W_\a^{-1} q_\a^M X_i^\a \delta(\br-\br_{ss}),
\EA
\end{subequations}
