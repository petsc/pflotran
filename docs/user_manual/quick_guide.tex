...
modern C and Fortran (95 standard or later) compilers and an available 
...
The source code for PFLOTRAN can be downloaded from the LANL web site using Mercurial: \verb|hg clone https://bitbucket.org/pflotran/pflotran-dev|. 
