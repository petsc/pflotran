...
The leakage of CO$_2$ through the leaky well as a function of time is shown in Figure \ref{fleaky_flx}. This is defined as the CO$_2$ mass flow midway between the top and bottom domain divided by the injection rate. The maximum value in the leak  occurs at approximately 800 d. The leak begins at approximately 50 d.
