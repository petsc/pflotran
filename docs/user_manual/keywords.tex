...
\newpage
\subsection{Links to Subsurface Keywords}
...
CHEMISTRY
  ...
  /
  RADIOACTIVE_DECAY_REACTION
    ! Note that C(aq) decays with no daugher products
    REACTION C(aq) <->
    HALF_LIFE 5. y
  /
  ...
...
Specifies parameters for general aqueous forward/backward kinetic reaction.
...
\item [REACTION] <string>
Reaction equation. The forward rate is applied to reaction quotient of species on left side of reaction. The reverse or backward rate is applied to the right side.
