...
set y2label 'pH'
set ylabel 'Reaction Rate'
set y2tics nomirror
#set title '20,000 years'
plot \
'pflotran001.tec' u 1:($20*1.e-3) t 'PFLOTRAN: Kfs' w l lw 2 lt 1,\
'pflotran001.tec' u 1:($21*1.e-3) t 'PFLOTRAN: Mus' w l lw 2 lt 2,\
'pflotran001.tec' u 1:($22*1.e-3) t 'PFLOTRAN: Gib' w l lw 2 lt 3,\
'pflotran001.tec' u 1:($23*1.e-3) t 'PFLOTRAN: Kln' w l lw 2 lt 4,\
'pflotran001.tec' u 1:6 axes x1y2 t 'PFLOTRAN: pH' w l lw 2 lt 9,\
'./flotran/transmin1.xyp' u 1:3 t 'FLOTRAN: Kfs' w lp lt 1,\
'./flotran/transmin1.xyp' u 1:4 t 'FLOTRAN: Mus' w lp lt 2,\
'./flotran/transmin1.xyp' u 1:5 t 'FLOTRAN: Gib' w lp lt 3,\
'./flotran/transmin1.xyp' u 1:6 t 'FLOTRAN: Kln' w lp lt 4,\
'./flotran/transaq1.xyp' u 1:2 axes x1y2 t 'FLOTRAN: pH' w lp lt 9
#    EOF
