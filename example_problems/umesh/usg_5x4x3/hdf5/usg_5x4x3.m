...
hdf5write('usg_5x4x3.h5', '/Domain/Cells', tmp', ...
    ...
    '/Regions/Top_faceid/Face Ids',uint64(top_faceid'), ...
    '/Regions/South_faceid/Cell Ids',uint64(south_cell_id'), ...
    '/Regions/South_faceid/Face Ids',uint64(south_faceid'), ...
    '/Regions/North_faceid/Cell Ids',uint64(north_cell_id'), ...
    '/Regions/North_faceid/Face Ids',uint64(north_faceid'), ...
    '/Regions/West_faceid/Cell Ids',uint64(west_cell_id'), ...
    '/Regions/West_faceid/Face Ids',uint64(west_faceid'), ...
    '/Regions/East_faceid/Cell Ids',uint64(east_cell_id'), ...
    '/Regions/East_faceid/Face Ids',uint64(east_faceid'), ...
