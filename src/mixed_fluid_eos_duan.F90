...
!        apply mixing rules
  ...
  subroutine mixture_eos_noderiv (p,t,xga,sg, energyscale,num_phase,num_spec,&
                    ...
                    pckr_m,pckr_pcmax,sat_pressure,den,avgmw,h, u,diff,hen,pc,kvr,ierr)
...
!********************************************************************* 
    ...
    hg=hg*1.D-3
    call Henry_CO2_noderiv(xla,tmp,t,p*xga, co2_phi, henry,co2_poyn)
!   henry=henry
...
!    print *,1.D0-sg,kr(1),kr(2),pc(1),kr_s(1),kr_s(2),pc_s(2)
    ...
    avgmw(2)=xgw*18.0153+xga*28.96
    avgmw_c(2)= 10.9447
    avgmw_c(1)= Hen(2)*10.9447
