...
subroutine RichardsFluxDerivative(aux_var_up,por_up,tor_up,sir_up,dd_up,perm_up,Dk_up, &
  ...
  real*8 :: dphi_dp_up, dphi_dp_dn, dphi_dt_up, dphi_dt_dn
  real*8 :: dukvr_dp_up, dukvr_dp_dn, dukvr_dt_up, dukvr_dt_dn
  real*8 :: duh_dp_up, duh_dp_dn, duh_dt_up, duh_dt_dn
...
subroutine RichardsBCFluxDerivative(ibndtype,aux_vars,aux_var_up,aux_var_dn, &
  ...
  integer :: ispec
  real*8 :: v_darcy
  real*8 :: fluxm(option%nspec),fluxe,q,density_ave
  ...
  real*8 :: dphi_dp_dn, dphi_dt_dn
  real*8 :: dukvr_dp_dn, dukvr_dt_dn
  real*8 :: duh_dp_dn, duh_dt_dn
...
subroutine RichardsAnalyticalResidual(snes,xx,r,realization,ierr)
 ...
 PetscViewer :: viewer
  ...
  integer :: iconn, idof, istart, iend
