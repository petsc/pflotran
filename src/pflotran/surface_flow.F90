...
subroutine SurfaceFlowResidualPatch1(realization)
  ...
  !gb: NOTE This is an important distinction between RichardsResidualPatch1()
  !    and SurfaceFlowResidualPatch1()
  !grid => patch%grid
  grid => realization%discretization%surfgrid
  option => realization%option
  field => realization%field
  ...
  write(*,*),'In SurfaceFlowResidualPatch1'
