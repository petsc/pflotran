...
*/
#include "PflotranTransportPreconditionerParameters.h"

namespace SAMRAI {

PflotranTransportPreconditionerParameters::PflotranTransportPreconditionerParameters()
{
   d_db.setNull();
   d_hierarchy.setNull();
...
PflotranTransportPreconditionerParameters::PflotranTransportPreconditionerParameters(const tbox::Pointer<tbox::Database> &db)
   :d_db(db)
{
   d_hierarchy.setNull();
   d_cf_interpolant          = NULL;
