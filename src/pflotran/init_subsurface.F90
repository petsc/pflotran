...
!....................
      ...
      case ('UNIFORM_VELOCITY')
        ...
        if (input%ierr == 0) then
          units_conversion = UnitsConvertToInternal(word,'length/time',option) 
        ...
        do
          ...
          select case(trim(word))
            ...
            case('FINAL_TIME')
              ...
              temp_real2 = UnitsConvertToInternal(word,'time',option)
            ...
            case('INITIAL_TIMESTEP_SIZE')
              ...
              dt_init = temp_real*UnitsConvertToInternal(word,'time',option)
            case('MINIMUM_TIMESTEP_SIZE')
              ...
              dt_min = temp_real*UnitsConvertToInternal(word,'time',option)
            case('MAXIMUM_TIMESTEP_SIZE')
              ...
              waypoint => WaypointCreate()
              waypoint%dt_max = temp_real*UnitsConvertToInternal(word,'time',option)
              call InputReadWord(input,option,word,PETSC_TRUE)
              if (input%ierr == 0) then
                call StringToUpper(word)
                if (StringCompare(word,'AT',TWO_INTEGER)) then
                  ...
                  waypoint%time = temp_real*UnitsConvertToInternal(word,'time',option)
                else
