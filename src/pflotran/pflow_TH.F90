...
! external VISW, PSAT, WATEOS
  ...
  PetscInt :: m, m1, m2, mu, n1, n2, ip1, ip2, p1, p2, t1, t2
  ...
  PetscReal, pointer :: r_p(:), porosity_loc_p(:), volume_p(:), &
               ...
               vl_p(:), &
                          ...
                          v_t_p(:), v_t_loc_p(:), &
                          ithrm_loc_p(:)
  PetscReal :: accum, dd1, dd2, eeng, eng, cond, den, density_ave, &
...
! external WATEOS, VISW, PSAT
  ...
  PetscInt :: ibc  ! Index that specifies a boundary condition block.
  PetscInt :: p1, t1, p2, t2
  PetscReal :: daccep, daccet, elem1, elem2
  PetscReal :: sat_pressure, dw_kg, dw_mol
  PetscReal, pointer :: porosity_loc_p(:), volume_p(:), &
                      ...
                      perm_xx_loc_p(:), perm_yy_loc_p(:), perm_zz_loc_p(:), &
                          ...
                          v_t_loc_p(:), &
                          ithrm_loc_p(:)
  PetscReal :: dd1, dd2, den, cond, trans, trans1, trans2, density_ave, voldt, pvoldt
  PetscReal :: dfluxp,dfluxt,dfluxp1,dfluxt1,dfluxp2,dfluxt2,gravity
  PetscReal :: dd, f1, f2, v_darcy, perm1, perm2, q, qt1, qt2, qp1, qp2, &
            qdt1, qdt2, hm1, hm2
