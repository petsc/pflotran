...
!geh  call assignMaterialPropToRegions(realization)
  call RealizInitMaterialProperties(realization)
...
subroutine RealizInitMaterialProperties(realization)
  ! 
  ...
  call RealizAllocMatPropDataStructs(realization)
  call RealizAssignMatIDsToRegions(realization)
  call RealizAssignMaterialProperties(realization)
  
end subroutine RealizInitMaterialProperties

! ************************************************************************** !

subroutine RealizAllocMatPropDataStructs(realization)
  ! 
...
end subroutine RealizAllocMatPropDataStructs

! ************************************************************************** !

subroutine RealizAssignMatIDsToRegions(realization)
  ! 
...
subroutine RealizAssignMaterialProperties(realization)
  ! 
  ...
  do material_id = 1, size(patch%material_property_array)
    ...
    if (associated(material_property)) then
      if (associated(material_property%permeability_dataset)) then
        call RealizReadPermsFromFile(realization,material_property)
      endif
      if (associated(material_property%porosity_dataset)) then
        string = ''
        string2 = 'Porosity'
...
end subroutine RealizAssignMaterialProperties

! ************************************************************************** !

subroutine RealizAssignVolumesToMatAuxVars(realization)
  ! 
...
end subroutine RealizAssignVolumesToMatAuxVars

! ************************************************************************** !

subroutine RealizReadMaterialIDsFromFile(realization,realization_dependent, &
                                         filename)
  ! 
...
end subroutine RealizReadMaterialIDsFromFile

! ************************************************************************** !

subroutine RealizReadPermsFromFile(realization,material_property)
  ! 
...
end subroutine RealizReadPermsFromFile
