...
!    PetscReal, pointer :: dtstep(:)    
  ...
  public :: TrTimestepperCreate, TrTimestepperDestroy, TrStepperRun
...
!
! ************************************************************************** !
function TrTimestepperCreate()

  implicit none
  
  type(tr_stepper_type), pointer :: TrTimestepperCreate
...
end function TrTimestepperCreate 
...
!
! ************************************************************************** !
subroutine TrTimestepperDestroy(stepper)
...
end subroutine TrTimestepperDestroy
  
end module Transport_Timestepper_module
