...
! ************************************************************************** !
!
! RTSecondaryTransportJacobian: Calculates the source term jacobian 
! contribution due to secondary continuum in the primary continuum 
! author: Satish Karra
! date: 10/08/12
!
! ************************************************************************** !
...
! ************************************************************************** !
!
! RTSecondaryTransportJacobianMulti: Calculates the source term jacobian 
! contribution due to secondary continuum in the primary continuum jacobian 
! for multicomponent system
! author: Satish Karra
! date: 1/15/13
!
! ************************************************************************** !
subroutine RTSecondaryTransportJacobianMulti(aux_var,sec_transport_vars, &
                                             global_aux_vars, &
                                             diffusion_coefficient, &
                                             porosity, &
                                             reaction, &
  ...
  sec_zeta = sec_transport_vars%sec_zeta
  conc_upd = sec_transport_vars%updated_conc
  conc_prev = sec_transport_vars%sec_conc*global_aux_vars%den_kg(1)*1.d-3 
  ! Note that sec_transport_vars%sec_conc units are in mol/kg
  ! Need to convert to mol/L since the units of conc. in the Thomas 
  ! algorithm are in mol/L 
