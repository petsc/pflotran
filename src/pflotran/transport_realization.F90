module Transport_Realization_module
...
#include "definitions.h"
  ...
  type, public :: tr_realization_type
...
!
! ************************************************************************** !
function TrRealizationCreate()

  implicit none
  
  type(tr_realization_type), pointer :: TrRealizationCreate
...
end function TrRealizationCreate  
...
!
! ************************************************************************** !
subroutine TrRealizationDestroy(realization)
...
end module Transport_Realization_module
