module Transport_Solver_module
...
#include "include/finclude/petscsnes.h"
  ...
  end type tr_solver_type

  public :: TrSolverCreate, &
            TrSolverDestroy, &
            TrSolverRead
...
!
! ************************************************************************** !
function TrSolverCreate()

  implicit none
  
  type(tr_solver_type), pointer :: TrSolverCreate
  ...
  TrSolverCreate => solver
  
end function TrSolverCreate
...
!
! ************************************************************************** !
subroutine TrSolverRead(solver,fid,myrank)

  use Fileio_module
  
  implicit none

  type(tr_solver_type) :: solver
  PetscInt :: fid
  PetscMPIInt :: myrank
...
!
! ************************************************************************** !
subroutine TrSolverDestroy(solver)
...
end subroutine TrSolverDestroy
  
end module Transport_Solver_module
