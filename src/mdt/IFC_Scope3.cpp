...
IFC_Scope3::IFC_Scope3(Grid **grid_) {
...
//  river_polygon->createRiverEdgePolygon();
  ...
  spp_polygon->createSPPPolygonCorrect();
...
void IFC_Scope3::setEastBoundaryMaterialTo2(Grid *grid) {
...
void IFC_Scope3::computeWestBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Scope3::computeEastBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Scope3::computeSouthBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Scope3::computeNorthBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Scope3::computeBottomBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Scope3::computeTopBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Scope3::computeIFCBoundary(Grid *grid, Polygon *p) {
...
void IFC_Scope3::computeTopSPPDomain(Grid *grid, Polygon *p) {
...
void IFC_Scope3::computeSatSPPDomain(Grid *grid, Polygon *p) {
...
void IFC_Scope3::computeUnSatSPPDomain(Grid *grid, Polygon *p) {
...
void IFC_Scope3::flagGridCells(Grid *grid) {
...
void IFC_Scope3::setMaterialIdBasedOnNaturalId(PetscInt natural_id, PetscInt material_id,
                                             Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
...
void IFC_Scope3::setActiveBasedOnNaturalId(PetscInt natural_id, PetscInt active,
                                         Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
    if (grid->cells[i].getIdNatural() == natural_id) 
