...
void MAD::computeWestBoundary(Grid *grid, PetscInt complete) {
...
void MAD::computeEastBoundary(Grid *grid, PetscInt complete) {
...
void MAD::computeSouthBoundary(Grid *grid, PetscInt complete) {
...
void MAD::computeNorthBoundary(Grid *grid, PetscInt complete) {
...
void MAD::computeBottomBoundary(Grid *grid, PetscInt complete) {
...
void MAD::computeTopBoundary(Grid *grid, PetscInt complete) {
...
void MAD::computeIFCBoundary(Grid *grid, Polygon *p) {
...
void MAD::computeSatSPPDomain(Grid *grid, Polygon *p) {
...
void MAD::computeUnSatSPPDomain(Grid *grid, Polygon *p) {
...
void MAD::flagGridCells(Grid *grid) {
...
void MAD::setMaterialIdBasedOnNaturalId(PetscInt natural_id, PetscInt material_id,
                                             Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
...
void MAD::setActiveBasedOnNaturalId(PetscInt natural_id, PetscInt active,
                                         Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
    if (grid->cells[i].getIdNatural() == natural_id) 
