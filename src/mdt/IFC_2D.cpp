...
void IFC_2D::computeWestBoundary(Grid *grid, PetscInt complete) {
...
void IFC_2D::computeEastBoundary(Grid *grid, PetscInt complete) {
...
void IFC_2D::computeBottomBoundary(Grid *grid, PetscInt complete) {
...
void IFC_2D::computeTopBoundary(Grid *grid, PetscInt complete) {
...
void IFC_2D::flagGridCells(Grid *grid) {
...
void IFC_2D::setMaterialIdBasedOnNaturalId(PetscInt natural_id, PetscInt material_id,
                                             Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
...
void IFC_2D::setActiveBasedOnNaturalId(PetscInt natural_id, PetscInt active,
                                         Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
    if (grid->cells[i].getIdNatural() == natural_id) 
