...
IFC_Plot_120x120x20::IFC_Plot_120x120x20(Grid **grid_) {
...
void IFC_Plot_120x120x20::computeWestBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Plot_120x120x20::computeEastBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Plot_120x120x20::computeSouthBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Plot_120x120x20::computeNorthBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Plot_120x120x20::computeBottomBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Plot_120x120x20::computeTopBoundary(Grid *grid, PetscInt complete) {
...
void IFC_Plot_120x120x20::computeIFCBoundary(Grid *grid, Polygon *p) {
...
void IFC_Plot_120x120x20::flagGridCells(Grid *grid) {
...
void IFC_Plot_120x120x20::setMaterialIdBasedOnNaturalId(PetscInt natural_id, PetscInt material_id,
                                             Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
...
void IFC_Plot_120x120x20::setActiveBasedOnNaturalId(PetscInt natural_id, PetscInt active,
                                         Grid *grid) {
  for (PetscInt i=0; i<grid->getNumberOfCellsGhosted(); i++) 
    if (grid->cells[i].getIdNatural() == natural_id) 
...
IFC_Plot_120x120x20::~IFC_Plot_120x120x20() {
  if (ascii_grids) {
    for (PetscInt i=0; i<AsciiGrid::nasciigrids; i++)
