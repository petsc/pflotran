#ifndef IFC_Plot_120x120x20_H_
#define IFC_Plot_120x120x20_H_
...
class IFC_Plot_120x120x20 {
  
public:
  IFC_Plot_120x120x20(Grid **grid);
  virtual ~IFC_Plot_120x120x20();
