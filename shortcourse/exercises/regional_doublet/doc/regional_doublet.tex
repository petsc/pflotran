...
\begin{itemize}
  ...
  \item Grid resolution $50 \times 49.02 \times 5$ m (($100 \times$ 51 $\times$ 20 cells)
...
FLOW_CONDITION initial
  ...
  GRADIENT
    PRESSURE -0.002 0. 0. \bluecomment{! gradient for pressure \redcomment{[-]}}
  /                       \bluecomment{!   unless \redcomment{dz} specified}
