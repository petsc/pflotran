...
\frame{\frametitle{Description of 1D 1D Variably Saturated Flow Scenario}
...
GRID
  ...
  BOUNDS          \bluecomment{! define the rectangular domain}
    0.d0 1.d0     \bluecomment{! xmin xmax}
    0.d0 1.d0     \bluecomment{! ymin ymax}
    0.d0 10.d0    \bluecomment{! zmin zmax}
...
FLOW_CONDITION recharge  \bluecomment{! named \greencomment{recharge}}
  ...
  /
  FLUX 3.170979d-9       \bluecomment{! Darcy velocity of 10 cm/y}
END
\end{semiverbatim}
...
\item Couple the \greencomment{initial} flow condition with region \greencomment{bottom} for the \redcomment{outlet} boundary condition.
\end{itemize}

\begin{semiverbatim}

BOUNDARY_CONDITION outlet     \bluecomment{! name is optional,}
  FLOW_CONDITION initial      \bluecomment{!   but recommended}
  REGION bottom
END
