...
\subsection{2D Copper Leaching Model}

\frame{\frametitle{Description of 2D Copper Leaching Problem}
...
%-----------------------------------------------------------------------------
\frame{\frametitle{Mineral Kinetic Rate Law}

\begin{itemize}
\item Transition State Theory (TST) Rate Law:
\EQ
I_m \eq -a_m \left(\sum_l k_{ml} \P_{ml}\right) \left(1-K_m Q_m\right) \zeta_m
\EN
\EQ
